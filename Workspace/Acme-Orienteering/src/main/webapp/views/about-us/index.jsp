...
<spring:message code="aboutUs.group"/>: 002
<br />
<spring:message code="aboutUs.name"/>: Acme
<br />
...
<br />
<spring:message code="aboutUs.email"/>: acme@us.es
<br />
<spring:message code="aboutUs.phone"/>: 665544123
<br />
<spring:message code="aboutUs.place"/>